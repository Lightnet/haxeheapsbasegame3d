...
class ModelTest02 extends examples.SampleApp {
	...
	override function init() {
		...
		charobject = cache.loadModel(hxd.Res.mbanime_female0401);
		//charobject = obj;
		//obj.scale(0.1);
		...
		idle = cache.loadAnimation(hxd.Res.mbanime_female0401_Idle);
		//walk = cache.loadAnimation(hxd.Res.animemale0301_walk);
		walk = cache.loadAnimation(hxd.Res.mbanime_female0401_walk);
